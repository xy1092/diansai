...
#error "NUEDC_USE_K230 requires a UART_K230 instance in SysConfig; current PA21/PA22 are MODE0/MODE1."
#endif

/* ---------- Reserved Extension Ports ---------- */
#ifdef GPIO_RESERVED_ULTRASONIC_TRIG_PIN
#define ULTRASONIC_PORT         GPIO_RESERVED_PORT
#define ULTRASONIC_TRIG_PIN     GPIO_RESERVED_ULTRASONIC_TRIG_PIN
#define ULTRASONIC_ECHO_PIN     GPIO_RESERVED_ULTRASONIC_ECHO_PIN
#endif
